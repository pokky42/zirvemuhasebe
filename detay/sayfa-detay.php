					...
					<div class="row">
						<div class="col-md-8">
							<div class="service_details_left headline">
								<img src="resimler/<?=$sayfalar["resim"]?>" alt="">
								<h2><?=$sayfalar["adi"]?></h2>
								<article>
<?=$sayfalar["aciklama"]?>								</article>
							</div>
						</div>
						<!-- /single left content -->
						<div class="col-md-4">
							<div class="single-sidebar">
								<div class="single_widget">
									<div class="service_itemlist ul-li-block">
										<ul>
											<?php
                        $cek = $db->query("select * from sayfalar where durum='0' and not id='$id' order by sira asc")->fetchAll(PDO::FETCH_ASSOC);
