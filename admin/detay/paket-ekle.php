...
if($_GET["islem"]=='duzenle'){
    $guncelle = $db->query("select * from paketler where id='{$_GET["id"]}'")->fetch(PDO::FETCH_ASSOC);
}
?>
                           ...
                           <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading"><h3 class="panel-title">Paket Ekle</h3></div>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group ">
                                                <div class="col-sm-offset-11 col-sm-1">
                                                    <?php if($_GET["islem"]=='duzenle'){?>
                                                    <input type="hidden" name="link" value="../paket-ekle?islem=duzenle&id=<?=$guncelle["id"]?>">
                                                    <input type="hidden" name="id" value="<?=$guncelle["id"]?>">
                                                  <button type="submit" name="paket-guncelle" class="btn btn-info waves-effect waves-light">Güncelle</button>
                                                  <?php } else {?>
                                                  <input type="hidden" name="link" value="../paket-ekle">
                                                  <button type="submit" name="paket-ekle" class="btn btn-info waves-effect waves-light">Ekle</button>
                                                  <?php }?>
                                                </div>
                                            </div>
