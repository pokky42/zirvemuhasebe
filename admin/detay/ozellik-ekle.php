...
if($_GET["islem"]=='duzenle'){
    $guncelle = $db->query("select * from ozellik where id='{$_GET["id"]}'")->fetch(PDO::FETCH_ASSOC);
}
?>
                           ...
                           <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading"><h3 class="panel-title">Özellik Ekle</h3></div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" id="example-email" name="adi" class="form-control" value="<?=$guncelle["adi"]?>">
                                                           ...
                                                           <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">Açıklama</label>
                                                <div class="col-md-10">
                                                    <input type="text" id="example-email" name="aciklama" class="form-control" value="<?=$guncelle["aciklama"]?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group ">
                                                <div class="col-sm-offset-11 col-sm-1">
                                                    <?php if($_GET["islem"]=='duzenle'){?>
                                                    <input type="hidden" name="link" value="../ozellik-ekle?islem=duzenle&id=<?=$guncelle["id"]?>">
                                                    <input type="hidden" name="id" value="<?=$guncelle["id"]?>">
                                                  <button type="submit" name="ozellik-guncelle" class="btn btn-info waves-effect waves-light">Güncelle</button>
                                                  <?php } else {?>
                                                  <input type="hidden" name="link" value="../ozellik-ekle">
                                                  <button type="submit" name="ozellik-ekle" class="btn btn-info waves-effect waves-light">Ekle</button>
                                                  <?php }?>
                                                </div>
                                            </div>
